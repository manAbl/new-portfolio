  ...
  <div class="svg-wrapper">
    ...
    >
      ...
      <path
        ...
        fill="#c8cad7"
      />
      <circle cx="216.27" cy="180.55" r="4.88" fill="red" />
      <circle cx="230.9" cy="180.55" r="4.88" fill="yellow" />
      <circle cx="245.53" cy="180.55" r="4.88" fill="green" />
...
@import '../assets/scss/components/dashboard-svg.scss';
</style>
