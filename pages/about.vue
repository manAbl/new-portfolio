<template>
  <div class="container grid mx-auto hero">
    <div class="svg-wrapper">
      ...
      >
        ...
        <g opacity="0.2">
          <path
            d="M1023.5,798.41a17.73,17.73,0,0,1-1.73,2.67q-8.64-6.09-17.57-11.93c.12-.25.25-.51.39-.76a16.84,16.84,0,0,1,6-6.52c3.29-2,7-2.48,10-.86s4.76,4.94,4.94,8.78A16.84,16.84,0,0,1,1023.5,798.41Z"
          ...
          <ellipse
            ...
            rx="14.01"
            ry="10.7"
            transform="translate(-160.29 1245.24) rotate(-62.09)"
            fill="#3f3d56"
          />
          <ellipse
            cx="1030.07"
            ...
            rx="14.01"
            ry="10.7"
            transform="translate(-142.65 1244.27) rotate(-62.09)"
            fill="#3f3d56"
          />
          <ellipse
            cx="1038.09"
            ...
            rx="14.01"
            ry="10.7"
            transform="translate(-125.01 1243.3) rotate(-62.09)"
            fill="#3f3d56"
          />
          <ellipse
            cx="1046.11"
            ...
            rx="14.01"
            ry="10.7"
            transform="translate(-107.37 1242.33) rotate(-62.09)"
            fill="#3f3d56"
          />
          <path
            d="M1065.55,610.51a51.89,51.89,0,0,1-.78-7l27,9.08-27-14A51.4,51.4,0,0,1,1083,562.14L1109.11,600l-20.31-42.07a51.28,51.28,0,1,1,48,90.35,51.19,51.19,0,0,1,.8,11l-41.15-.32,40.52,6.67a51.33,51.33,0,0,1-29.84,38.68,51.28,51.28,0,1,1-71.23-37.72,51.29,51.29,0,0,1,29.67-56Z"
            transform="translate(-16.24 -71.99)"
            fill="#6c63ff"
          />
          <path
            d="M1131.64,681.39a51,51,0,0,1-24.53,22.88,51.28,51.28,0,1,1-71.23-37.72C1033.89,655.62,1134.34,676.31,1131.64,681.39Z"
            transform="translate(-16.24 -71.99)"
            opacity="0.1"
          />
        </g>
        <g opacity="0.2">
          <path
            d="M991.37,495.94a31.64,31.64,0,0,1-2.25,4.64q-15.11-8.06-30.61-15.66c.14-.43.3-.88.47-1.31a27.2,27.2,0,0,1,8.3-11.66c4.87-3.9,10.74-5.37,16-3.38s8.62,7,9.67,13.11A27.21,27.21,0,0,1,991.37,495.94Z"
            transform="translate(-16.24 -71.99)"
            fill="#3f3d56"
          />
          <ellipse
            ...
            rx="22.69"
            ry="17.33"
            transform="translate(184.88 1147.47) rotate(-69.16)"
            fill="#3f3d56"
          />
          <ellipse
            cx="994.89"
            ...
            rx="22.69"
            ry="17.33"
            transform="translate(215.46 1139.99) rotate(-69.16)"
            fill="#3f3d56"
          />
          <ellipse
            cx="1004.76"
            ...
            rx="22.69"
            ry="17.33"
            transform="translate(246.03 1132.51) rotate(-69.16)"
            fill="#3f3d56"
          />
          <ellipse
            cx="1014.62"
            ...
            rx="22.69"
            ry="17.33"
            transform="translate(276.61 1125.04) rotate(-69.16)"
            fill="#3f3d56"
          />
          <path
            d="M1021.49,185.69a83.36,83.36,0,0,1-2.65-11.18l45.22,9.21-46.16-17.18a83.11,83.11,0,0,1,21.91-62L1089.37,160l-41-63.53a83,83,0,1,1,95.09,135.6,83.42,83.42,0,0,1,3.46,17.51l-66.17,7.68,66.43,2.65A83.07,83.07,0,0,1,1106.93,328a83,83,0,1,1-122-46.42,83,83,0,0,1,36.52-95.93Z"
            transform="translate(-16.24 -71.99)"
            fill="#6c63ff"
          />
          <path
            d="M1141.79,286.39A82.59,82.59,0,0,1,1106.93,328a83,83,0,1,1-122-46.42C979.6,264.46,1145.11,277.69,1141.79,286.39Z"
            transform="translate(-16.24 -71.99)"
            opacity="0.1"
          />
        </g>
        <g opacity="0.2">
          <path
            d="M194.62,582.15a37.29,37.29,0,0,0,2,5.8q19-7.28,38.43-14c-.11-.53-.22-1.08-.36-1.62a32.41,32.41,0,0,0-8.07-15c-5.18-5.32-11.89-7.92-18.34-6.34s-11.2,7-13.35,14A32.49,32.49,0,0,0,194.62,582.15Z"
            transform="translate(-16.24 -71.99)"
            fill="#3f3d56"
          />
          <ellipse
            ...
            rx="20.61"
            ry="26.98"
            transform="translate(-139.61 -7.4) rotate(-13.72)"
            fill="#3f3d56"
          />
          <ellipse
            cx="199.01"
            ...
            rx="20.61"
            ry="26.98"
            transform="translate(-132.24 -10.16) rotate(-13.72)"
            fill="#3f3d56"
          />
          <ellipse
            cx="191.2"
            ...
            rx="20.61"
            ry="26.98"
            transform="translate(-124.87 -12.93) rotate(-13.72)"
            fill="#3f3d56"
          />
          <ellipse
            cx="183.38"
            ...
            rx="20.61"
            ry="26.98"
            transform="translate(-117.5 -15.7) rotate(-13.72)"
            fill="#3f3d56"
          />
          <path
            d="M204.82,211.62a97.86,97.86,0,0,0,4.78-12.8L154.89,203l57-13.46a98.81,98.81,0,0,0-16.71-76.43L128.5,171.35l57.77-68.92a98.72,98.72,0,1,0-132.2,146,99.32,99.32,0,0,0-6.67,20.16l76.95,18.81-78.78-6.67A98.81,98.81,0,0,0,83,367a98.71,98.71,0,1,0,150.76-36.8,98.71,98.71,0,0,0-29-118.58Z"
            transform="translate(-16.24 -71.99)"
            fill="#6c63ff"
          />
          <path
            d="M48,312.71A98.29,98.29,0,0,0,83,367a98.71,98.71,0,1,0,150.76-36.8C242.64,310.75,45.39,302,48,312.71Z"
            transform="translate(-16.24 -71.99)"
            opacity="0.1"
          />
        </g>
        <path
          d="M1072.54,185.7H103.8a8.64,8.64,0,0,0-8.63,8.66V787.24a17.43,17.43,0,0,0,17.4,17.46h951.2a17.43,17.43,0,0,0,17.4-17.46V194.36A8.65,8.65,0,0,0,1072.54,185.7Z"
          transform="translate(-16.24 -71.99)"
          fill="url(#b752362c-f89d-48d5-9dd1-266417fc8d3c)"
        />
        <path
        ...
        />
        <path
          d="M1077.25,197.57v24.94h-978V197.57a8.56,8.56,0,0,1,8.56-8.56h960.88A8.56,8.56,0,0,1,1077.25,197.57Z"
          transform="translate(-16.24 -71.99)"
          fill="#ededf4"
        />
        ...
        <path
          ...
          opacity="0.1"
        />
        <ellipse cx="886.46" cy="740.19" rx="33.8" ry="6.5" fill="#6c63ff" />
        <ellipse cx="885.9" cy="737.43" rx="3.94" ry="5.15" fill="#3f3d56" />
        <ellipse cx="885.9" cy="731.13" rx="3.94" ry="5.15" fill="#3f3d56" />
        <ellipse cx="885.9" cy="724.84" rx="3.94" ry="5.15" fill="#3f3d56" />
        <ellipse cx="885.9" cy="718.54" rx="3.94" ry="5.15" fill="#3f3d56" />
        <ellipse cx="885.9" cy="712.24" rx="3.94" ry="5.15" fill="#3f3d56" />
        <ellipse cx="885.9" cy="705.95" rx="3.94" ry="5.15" fill="#3f3d56" />
        <ellipse cx="885.9" cy="699.65" rx="3.94" ry="5.15" fill="#3f3d56" />
        <path
        ...
        <path
          ...
          opacity="0.1"
        />
        <ellipse cx="270.46" cy="741.74" rx="15.3" ry="2.94" fill="#6c63ff" />
        <ellipse cx="270.21" cy="740.49" rx="1.78" ry="2.33" fill="#3f3d56" />
        <ellipse cx="270.21" cy="737.64" rx="1.78" ry="2.33" fill="#3f3d56" />
        <ellipse cx="270.21" cy="734.79" rx="1.78" ry="2.33" fill="#3f3d56" />
        <ellipse cx="270.21" cy="731.94" rx="1.78" ry="2.33" fill="#3f3d56" />
        <ellipse cx="270.21" cy="729.09" rx="1.78" ry="2.33" fill="#3f3d56" />
        <ellipse cx="270.21" cy="726.24" rx="1.78" ry="2.33" fill="#3f3d56" />
        <ellipse cx="270.21" cy="723.39" rx="1.78" ry="2.33" fill="#3f3d56" />
        <path
    ...
    <div class="description">
      <p class="text-2xl text-justify">
        Born and raised in Venezuela. Since november 2018 I'm living in
        Medellín, Colombia. I took interest in software development two years
        ago when I wanted to create my own personal tumblr profile on raw
        html/css and ever since I first tried coding I instantly loved it and
        the passion for creating things on my own has only grown.
      </p>
      <div id="map" />
    </div>
  </div>
